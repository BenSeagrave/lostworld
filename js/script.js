...
function initMap() {
  var lostworld = { lat: 51.771185, lng: 0.11995 };
...
// NO LONGER WORKS DUE TO INSTAGRAM ENABLING CORS
...
//     .then((data) =>
//       callback(data.graphql.user.edge_owner_to_timeline_media.edges)
//     );
// };
...
const faqs = [
  {
    ...
    answer:
      "First it’s best to have an idea of what you want, and any relevant images. We can then book you a consultation with your chosen artist, and the artist will take through some design ideas and begin the booking process with you.",
  },
  {
    question: "How should I prepare for my tattoo?",
    answer:
      "You should get a good nights sleep, eat plenty of food, and bring a sugary drink/snacks with you. Please make sure you're clean, especially the tattoo area, and you’re wearing appropriate clothing. Please don’t be drunk, high, be on blood thinning tablets, or ill. Any reason why we think you’re not in a suitable state we can refuse to tattoo you.",
  },
  {
    question: "How old do I have to be?",
    answer:
      "You have to be 18, anything under is illegal even with permission.",
  },
  {
    question: "What’s your minimum charge?",
    answer:
      "Our minimum charge is £40, this is what it costs to set up and block out a slot.",
  },
  {
    question: "How much does a tattoo cost?",
    answer:
      "Each tattoo varies in price depending on many factors. If you book a consultation with an artist or pop in we can give you a rough quote on the day.",
  },
  {
    question: "Does it hurt?",
    answer:
      "Everyone’s pain threshold is subjective, and also every place on the body is different! If you're nervous you can use a numbing cream, or book smaller sessions.",
  },
  {
    question: "What will happen in my appointment?",
    answer:
      "You will firstly have to fill out a form to make sure you understand the procedure and you meet our criteria. You will be called through when the artist is ready and the area will be prepped and the design applied. Once you have confirmed the design is what you want, the procedure will start, and once completed it will be dressed appropriately and you will be run through any aftercare.",
  },
  {
    question: "What if I can’t make my appointment?",
    answer:
      "We require 48 hours notice for you to keep your deposit if you wish to move your appointment. Please call us as this reaches us immediately if you do not inform us and you miss your appointment, your deposit will be taken.",
  },
  {
    question: "How long does my tattoo take to heal?",
    answer:
      "On average around two weeks to stop shedding, but around four weeks for it to be fully healed. The better it’s looked after the better it will heal!",
  },
  {
    question: "How do I look after my tattoo?",
    answer:
      "We will run through with you a procedure of aftercare after your appointment, but we go on a basic procedure of cleaning and creaming it on an average of three times a day.",
  },
  {
    question: "I think my tattoo is infected, what do I do?",
    answer:
      "Wash the whole area with an antibacterial wash and put a thin layer of savlon on it, and repeat this three times a day for two days. If it doesn’t get better please call us for a dive or consult a doctor.",
  },
  {
    question: "Do you accept card?",
    answer:
      "It’s cash only, and there isn’t a card machine nearby so please come prepared.",
  },
  {
...
contactForm.addEventListener("submit", (event) => {
  ...
  if (grecaptcha.getResponse() == "") {
    formStatusMessage.innerText =
      "Please validate the reCaptcha form above first!";
  } else {
